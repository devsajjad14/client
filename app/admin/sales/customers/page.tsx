...
import { FiArrowLeft, FiTrash2, FiSearch, FiRefreshCw, FiEdit2, FiEye, FiUser, FiDollarSign, FiShoppingBag, FiMail, FiX, FiSettings, FiCreditCard, FiTruck, FiLoader, FiChevronDown } from 'react-icons/fi'
      ...
      <div className="flex items-center justify-between bg-white rounded-lg border border-gray-200 shadow-sm px-6 py-4">
        <div className="flex items-center gap-4">
          <span className="text-sm text-gray-600">
            ...
            of <span className="font-medium text-gray-900">{filteredUsers.length}</span> customers
          </span>
        </div>
        ...
        {totalPages > 1 && (
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-md hover:bg-gray-50 hover:text-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
            >
